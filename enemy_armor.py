...
def update_monster_armor(valid_armor, pk_id):
    ...
    """
DB migrations:
ALTER TABLE monsters_armors ADD COLUMN ap_level int DEFAULT 0 NOT NULL CHECK (ap_level > -1);
ALTER TABLE
ALTER TABLE monsters_armors ADD COLUMN armor_points int DEFAULT 0 NOT NULL CHECK (armor_points > -1);
ALTER TABLE
ALTER TABLE monsters_armors ADD COLUMN mags int DEFAULT 0 NOT NULL CHECK (mags > -1);
