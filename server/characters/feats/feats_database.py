...
class Feats_Database:
    ...
    def get_characters_feats(self, character_pk_id):
    ...
    def validate_character_feat_map(self, form):
    ...
    def insert_character_feat_map(self, mapping):
